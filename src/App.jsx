...
var INIT_MANDATS = [
  { id:"m1",  ref:"MAN-001", typeBien:"appartement", typeMandat:"exclusif", adresse:"12 Rue Saint-Leu, Amiens",       prix:285000, commission:8550,  statut:"mandat",    agentId:"agent-1", agenceId:"agence-1", dateMandat:daysAgo(15),  dateExpiration:daysAhead(75),  dateCompromis:null,        dateSignature:null,          clausesSuspensivesLevees:false },
  { id:"m2",  ref:"MAN-002", typeBien:"appartement", typeMandat:"simple",   adresse:"8 Bd de Belfort, Amiens",         prix:195000, commission:5850,  statut:"compromis", agentId:"agent-2", agenceId:"agence-1", dateMandat:daysAgo(45),  dateExpiration:daysAhead(45),  dateCompromis:daysAgo(10), dateSignature:daysAhead(80), clausesSuspensivesLevees:false },
  { id:"m3",  ref:"MAN-003", typeBien:"maison",      typeMandat:"exclusif", adresse:"45 Rue de Noyon, Amiens",         prix:340000, commission:10200, statut:"vendu",     agentId:"agent-3", agenceId:"agence-1", dateMandat:daysAgo(90),  dateExpiration:daysAhead(0),   dateCompromis:daysAgo(60), dateSignature:daysAhead(5),  clausesSuspensivesLevees:true  },
  { id:"m4",  ref:"MAN-004", typeBien:"appartement", typeMandat:"exclusif", adresse:"3 Place Gambetta, Amiens",        prix:420000, commission:12600, statut:"compromis", agentId:"agent-1", agenceId:"agence-1", dateMandat:daysAgo(30),  dateExpiration:daysAhead(60),  dateCompromis:daysAgo(5),  dateSignature:daysAhead(90), clausesSuspensivesLevees:true  },
  { id:"m5",  ref:"MAN-005", typeBien:"maison",      typeMandat:"simple",   adresse:"22 Rue Gresset, Amiens",          prix:167000, commission:5010,  statut:"mandat",    agentId:"agent-4", agenceId:"agence-1", dateMandat:daysAgo(5),   dateExpiration:daysAhead(85),  dateCompromis:null,        dateSignature:null,          clausesSuspensivesLevees:false },
  { id:"m6",  ref:"MAN-006", typeBien:"maison",      typeMandat:"simple",   adresse:"7 Allée des Acacias, Longueau",   prix:255000, commission:7650,  statut:"mandat",    agentId:"agent-2", agenceId:"agence-1", dateMandat:daysAgo(80),  dateExpiration:daysAhead(10),  dateCompromis:null,        dateSignature:null,          clausesSuspensivesLevees:false },
  { id:"m7",  ref:"MAN-007", typeBien:"appartement", typeMandat:"exclusif", adresse:"18 Rue de Paris, Amiens",         prix:310000, commission:9300,  statut:"compromis", agentId:"agent-5", agenceId:"agence-1", dateMandat:daysAgo(55),  dateExpiration:daysAhead(35),  dateCompromis:daysAgo(20), dateSignature:daysAhead(60), clausesSuspensivesLevees:false },
  { id:"m8",  ref:"MAN-008", typeBien:"maison",      typeMandat:"simple",   adresse:"29 Rue Victor Hugo, Amiens",      prix:189000, commission:5670,  statut:"vendu",     agentId:"agent-3", agenceId:"agence-1", dateMandat:daysAgo(120), dateExpiration:daysAgo(5),     dateCompromis:daysAgo(80), dateSignature:daysAgo(10),   clausesSuspensivesLevees:true  },
  { id:"m9",  ref:"MAN-009", typeBien:"appartement", typeMandat:"exclusif", adresse:"54 Rue Delambre, Amiens",         prix:375000, commission:11250, statut:"mandat",    agentId:"agent-5", agenceId:"agence-1", dateMandat:daysAgo(25),  dateExpiration:daysAhead(65),  dateCompromis:null,        dateSignature:null,          clausesSuspensivesLevees:false },
  { id:"m10", ref:"MAN-010", typeBien:"maison",      typeMandat:"simple",   adresse:"11 Impasse des Lilas, Rivery",    prix:210000, commission:6300,  statut:"compromis", agentId:"agent-4", agenceId:"agence-1", dateMandat:daysAgo(60),  dateExpiration:daysAhead(30),  dateCompromis:daysAgo(15), dateSignature:daysAhead(75), clausesSuspensivesLevees:false },
  { id:"m11", ref:"MAN-011", typeBien:"appartement", typeMandat:"exclusif", adresse:"6 Rue des Jacobins, Amiens",      prix:298000, commission:8940,  statut:"vendu",     agentId:"agent-1", agenceId:"agence-1", dateMandat:daysAgo(200), dateExpiration:daysAgo(80),    dateCompromis:daysAgo(150),dateSignature:daysAgo(30),   clausesSuspensivesLevees:true  },
  { id:"m12", ref:"MAN-012", typeBien:"appartement", typeMandat:"simple",   adresse:"33 Rue Vulfran Warmé, Amiens",    prix:145000, commission:4350,  statut:"vendu",     agentId:"agent-2", agenceId:"agence-1", dateMandat:daysAgo(180), dateExpiration:daysAgo(60),    dateCompromis:daysAgo(120),dateSignature:daysAgo(15),   clausesSuspensivesLevees:false },
  { id:"m13", ref:"MAN-013", typeBien:"local_pro_vente", typeMandat:"exclusif", adresse:"19 Bd du Port, Amiens",           prix:520000, commission:15600, statut:"compromis", agentId:"agent-5", agenceId:"agence-1", dateMandat:daysAgo(20),  dateExpiration:daysAhead(70),  dateCompromis:daysAgo(3),  dateSignature:daysAhead(95), clausesSuspensivesLevees:false },
  { id:"m14", ref:"MAN-014", typeBien:"terrain",    typeMandat:"simple",   adresse:"47 Av de la République, Amiens",  prix:175000, commission:5250,  statut:"mandat",    agentId:"agent-3", agenceId:"agence-1", dateMandat:daysAgo(10),  dateExpiration:daysAhead(80),  dateCompromis:null,        dateSignature:null,          clausesSuspensivesLevees:false },
  { id:"m15", ref:"MAN-015", typeBien:"immeuble",   typeMandat:"exclusif", adresse:"2 Rue du Maréchal Foch, Amiens",  prix:390000, commission:11700, statut:"vendu",     agentId:"agent-1", agenceId:"agence-1", dateMandat:daysAgo(300), dateExpiration:daysAgo(120),   dateCompromis:daysAgo(200),dateSignature:daysAgo(60),   clausesSuspensivesLevees:true  },
];
var INIT_LOCATIONS = [
